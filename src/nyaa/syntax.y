...
%token DEF BLOCK_BEGIN BLOCK_END VAR VAL LAMBDA NAME COMPARISON OP_OR OP_XOR OP_AND OP_LSHIFT OP_RSHIFT UMINUS OP_CONCAT NEW TO UNTIL
%token IF ELSE WHILE FOR IN OBJECT CLASS PROPERTY BREAK CONTINUE RETURN VARGS DO THIN_ARROW FAT_ARROW UNLESS THEN
