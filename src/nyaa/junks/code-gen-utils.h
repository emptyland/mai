...
public:
    ...
    virtual void Call(IVal callee, int nargs, int wanted, int line, int trace_id) = 0;
    ...
    virtual void SetField(IVal self, IVal index, IVal value, int line, int trace_id) = 0;
    virtual void GetField(IVal value, IVal self, IVal index, int line, int trace_id) = 0;
    virtual void Closure(IVal closure, IVal func, int line) = 0;
    virtual void Self(IVal base, IVal callee, IVal method, int line, int trace_id) = 0;
